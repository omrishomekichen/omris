...
export const passwordResetSuccessTemplate = (name?: string): string => {
  ...
  return emailLayout({
    title: "Password Updated Successfully - Aira Pickles",
    ...
    content: `
      ...
      <p style="color: #475569;">This is confirmation that the password for your Aira Pickles account has been changed.</p>
