...
export const passwordChangeAlertTemplate = (time: string, name?: string): string => {
  ...
  return emailLayout({
    title: "Security Alert: Password Changed - Omri's Home Kichen",
    ...
    content: `
      ...
      <p style="color: #475569;">The password for your Omri's Home Kichen account was changed at <strong>${time}</strong>.</p>
