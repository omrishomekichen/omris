...
export const otpTemplate = (otp: string, name?: string): string => {
  ...
  return emailLayout({
    title: "Your Verification Code - Omri's Home Kichen",
    ...
    content: `
      ...
      <p style="color: #475569;">Use the 6-digit verification code below to complete your authentication with <strong>Omri's Home Kichen</strong>. This code is valid for <strong>15 minutes</strong>.</p>
