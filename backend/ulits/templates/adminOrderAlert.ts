...
export const adminOrderAlertTemplate = (data: AdminOrderAlertOptions): string => {
  ...
  return emailLayout({
    ...
    preheader: `New order #${data.orderId} of ₹${data.totalPrice} received on Omri's Home Kitchen`,
    content: `
      ...
      <div style="text-align: center; margin: 28px 0;">
        <a href="https://omris-home-kitchen.vercel.app/orders" class="btn" style="background-color: #059669;">Open Order Dashboard</a>
      </div>
    `,
  });
};
