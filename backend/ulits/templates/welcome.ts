...
export const welcomeTemplate = (name: string): string => {
  return emailLayout({
    ...
    content: `
      ...
      <p style="color: #475569;">We are thrilled to have you join <strong>Aira Pickles</strong>!</p>
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="https://aira-pickles.vercel.app/menu" class="btn">Explore Product Menu</a>
      </div>
