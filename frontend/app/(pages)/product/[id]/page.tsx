        ...
        <section className="artisanal-story-section">
          <div className="story-card-left">
            ...
            <p className="story-paragraph">
              Every jar of Aira Pickles is a labor of love. We start by hand-selecting the firmest, most tart raw green mangoes directly from local family orchards. The mangoes are washed, carefully sliced, and sun-dried to concentrate their natural tanginess.
            </p>
            <p className="story-paragraph">
