...
export const passwordChangeAlertTemplate = (time: string, name?: string): string => {
  ...
  return emailLayout({
    title: "Security Alert: Password Changed - Omri's Home Kitchen",
    ...
    content: `
      ...
      <p style="color: #475569;">The password for your Omri's Home Kitchen account was changed at <strong>${time}</strong>.</p>
