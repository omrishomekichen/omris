...
export const welcomeTemplate = (name: string): string => {
  return emailLayout({
    title: "Welcome to Omri's Home Kitchen",
    ...
    content: `
      ...
      <p style="color: #475569;">We are thrilled to have you join <strong>Omri's Home Kitchen</strong>!</p>
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="https://omris-home-kitchen.vercel.app/menu" class="btn">Explore Product Menu</a>
      </div>
