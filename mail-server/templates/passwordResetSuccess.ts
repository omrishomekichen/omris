...
export const passwordResetSuccessTemplate = (name?: string): string => {
  ...
  return emailLayout({
    title: "Password Updated Successfully - Omri's Home Kitchen",
    ...
    content: `
      ...
      <p style="color: #475569;">This is confirmation that the password for your Omri's Home Kitchen account has been changed.</p>
